...
<div class = "rare-box">
  ...
  `r ifelse(length(finaldat$scientific.name) > 0, kbl(finaldat) %>% kable_styling(bootstrap_options = "hover"), paste0("<h3> There were no review species observed this month in iNaturalist. </h3>"))`
  </div>
</div>
...
<div class = "credits-box">
  ...
  Chestnut-collared Longspur photo in the introduction © Louis Bevier
